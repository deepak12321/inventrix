    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 mt-6">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-xl border border-blue-200">
          <p className="text-sm text-blue-600 font-semibold mb-1">Subcategory</p>
          <p className="text-lg text-gray-800 font-medium capitalize">
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-4 rounded-xl border border-orange-200">
          <p className="text-sm text-orange-600 font-semibold mb-1">Cost Price</p>
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-xl border border-green-200">
          <p className="text-sm text-green-600 font-semibold mb-1">Selling Price</p>
          <p className="text-2xl text-gray-800 font-bold">
        ...
        <div
          className={`col-span-2 p-6 rounded-xl border-2 ${data.product_quantity <= data.product_min_quantity
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className={`text-4xl font-bold ${data.product_quantity <= data.product_min_quantity
                    ? "text-red-700"
                    : "text-emerald-700"
                  }`}
              >
      ...
      <div className="flex justify-center mt-6">
        <span
          className={`px-6 py-2 rounded-full text-sm font-bold ${data.is_active
